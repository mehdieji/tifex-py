...
def calculate_statistical_features(self, signal, signal_name):
        ...
        # # Cardinality
        # feats.extend(calculate_cardinality(signal))
        ...
        # energy_ratio = calculate_energy_ratio_by_chunks(signal)
        # for i, ratio in enumerate(energy_ratio):
        #     feats.append(ratio)
        #     feats_names.append(f"{signal_name}_energy_ratio_chunk_{i+1}")

        # # Moving Average
        # moving_average = calculate_moving_average(signal, window_size=10)  # Example window size
        # feats.append(moving_average)
        # feats_names.append(f"{signal_name}_moving_average")
        
        # # Weighted Moving Average
        # weighted_ma = calculate_weighted_moving_average(signal)
        ...
        # hist_bins = calculate_histogram_bin_frequencies(signal)
        ...
        # intercept = calculate_intercept_of_linear_fit(signal)
        ...
        # # Winsorized Mean
        # winsorized_mean = calculate_winsorized_mean(signal)
